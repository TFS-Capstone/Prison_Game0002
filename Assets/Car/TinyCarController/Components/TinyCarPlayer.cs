...
namespace DavidJalbert
{
    ...
    public class TinyCarPlayer : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            wheelSpin += car.getForwardVelocity() * Time.deltaTime * wheelsSpinForce;
            wheelRotation = Mathf.Lerp(wheelRotation, car.getSteering() * wheelsMaxTurnAngle, wheelsTurnSmoothing <= 0 ? 1 : Mathf.Clamp01(wheelsTurnSmoothing * Time.deltaTime));
