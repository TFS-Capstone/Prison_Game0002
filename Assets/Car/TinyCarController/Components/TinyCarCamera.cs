        ...
        void Update()
        {
            ...
            switch (viewMode)
            {
                case CAMERA_MODE.ThirdPerson:
                    ...
                    transform.rotation = Quaternion.Lerp(transform.rotation, Quaternion.Euler(rotationEuler), Mathf.Clamp01(thirdPersonInterpolation <= 0 ? 1 : thirdPersonInterpolation * Time.deltaTime));
